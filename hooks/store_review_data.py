...
class StoreReviewData(sgtk.Hook):
    ...
    def execute(self, local_publish_paths, version_data, **kwargs):
        ...
        # The default implementation uploads any the review files/moviesto Shotgun.
        # 
        ...
        local_file_attribs = p4_util.get_client_file_details(p4, local_publish_paths, ["-0a"])
        ...
        for local_path in local_publish_paths:
            ...
            sg_metadata_str = local_file_attribs[local_path].get("openattr-%s" % StoreReviewData.REVIEW_ATTRIB_NAME)
            if sg_metadata_str:
    ...
    def __upload_file_to_sg(self, file_path):
        """
        Upload the specified file to Shotgun
        """        
